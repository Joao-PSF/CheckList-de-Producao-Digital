                ...
                <aside class="sidebar-themed p-3 offcanvas-lg offcanvas-start" tabindex="-1"
                    ...
                    <div class="offcanvas-body d-flex flex-column p-0">
                        <div class="mb-4 border-bottom pb-3">
                            ...
                            <p class="small mb-0">Olá, <?php echo htmlspecialchars($_SESSION['nome']); ?>!
                            </p>
                        </div>

                        <nav class="nav nav-pills flex-column mb-auto">
                            <a href="home.php?page=dashboard" class="nav-link">Inicial</a>
                            <a href="home.php?page=estoque" class="nav-link">Estoque</a>
                            <a href="home.php?page=servicos" class="nav-link">Ordens de Serviços</a>
                            <a href="home.php?page=cadastro" class="nav-link">Cadastros Usuários</a>
                            <a href="home.php?page=relatorios" class="nav-link">Relatórios</a>
                        </nav>
